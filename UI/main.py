...
# L3 Slice Detection model weights
weight_frontal ="/path/to/frontal-weight.pt"
weight_sagittal = "/path/to/sagital-weight.pt"

# L3 Slice Segmentation model weights
weight_segment = "/path/to/segmentation-weights.pth"
...
def mip_to_normalized_slice_frontal(frontal_mip):
    ...
    model_frontal = YOLO(weight_frontal)
...
def mip_to_normalized_slice_sagittal(saggital_mip):
    ...
    model_sagittal = YOLO(weight_sagittal)
